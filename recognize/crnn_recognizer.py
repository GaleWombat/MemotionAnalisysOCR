...
# recognize api
class PytorchOcr():
    def __init__(self, model_path='/content/ocr/checkpoints/CRNN-1010.pth'):
        ...
        if torch.cuda.is_available():
            self.cuda = True
            self.model.cuda()
            self.model.load_state_dict({k.replace('module.', ''): v for k, v in torch.load('/content/ocr/checkpoints/CRNN-1010.pth').items()})
        else:
            self.model.load_state_dict(torch.load('/content/ocr/checkpoints/CRNN-1010.pth', map_location='cpu'))
        self.model.eval()
...
if __name__ == '__main__':
    # model_path = './ocr/recognize/crnn_models/CRNN-1008.pth'
